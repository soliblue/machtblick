...
| D | Members/parties/motions parity: detail tabs, filters, demographics, motion reachability | todo |
| E | Polish: navigation transitions, haptics, share sheet with OG cards, app-wide typography audit vs web | todo |
...
- `demographics{sex,age}` and a Verlauf/history payload are NOT added (out of this lane's scope; Verlauf/demographics tabs stay deferred).
