...
- Public TestFlight distribution and exact-build verification: in progress, build 31 is processed and assigned to the public group while its exact external state is being inspected without another upload
