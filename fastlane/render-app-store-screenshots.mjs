...
h1 { margin: 0; font-family: Fraunces, Georgia, serif; font-size: 132px; font-weight: 600; line-height: 0.96; letter-spacing: 0; }
h1 span { padding: 0 12px 7px; border-radius: 8px; box-decoration-break: clone; -webkit-box-decoration-break: clone; }
.copy-top { top: 96px; left: 56px; width: 1172px; }
.copy-bottom { top: 2180px; left: 56px; width: 1172px; }
.copy-bottom h1 { font-size: 140px; }
.locale-en-US .copy-bottom { top: 2290px; }
.copy-middle { top: 890px; left: 70px; width: 1144px; text-align: center; }
.copy-side { top: 80px; left: 56px; width: 1172px; }
.copy-side h1 { font-size: 128px; }
...
.phone-below { top: 640px; left: 72px; width: 1140px; }
.phone-above { top: -140px; left: 112px; width: 1060px; }
.phone-split-top { top: -1330px; left: 137px; width: 1010px; transform: rotate(-4deg); }
.phone-split-bottom { top: 1500px; left: 137px; width: 1010px; transform: rotate(4deg); }
.phone-side { top: 500px; left: 398px; width: 980px; transform: rotate(4deg); }
