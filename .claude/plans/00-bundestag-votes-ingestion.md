...
| Hidden historical archive BT1-BT15 | lead | partial |
...
- **lead** (deep archive): Added `etl:votes:historical` for hidden pre-2005 data. It imports BT1-BT15 terms, members, mandates, and affiliations from Bundestag `MDB_STAMMDATEN.XML`, and complete BT12-BT15 named-vote registry rows from the official Datenhandbuch 7.13 PDF. Validation hard-fails unless BT12=129, BT13=180, BT14=164, BT15=102. Local DB after run: BT1-BT15 mandate rows match all Stammdaten Wahlperioden with zero missing `bt_mdb_id`; BT12-BT15 votes total 575 with 2 special BT14 rows lacking normal yes/no/abstain counts. No pre-BT20 `vote_members` rows are fabricated. BT1-BT11 named votes are not inserted from `datenhandbuch_1949_1999_Gesamt.pdf` because section 8.14 is a selected counted-vote table, not the complete named-vote registry. Complete BT1-BT11 votes require parsing individual Plenarprotokoll PDFs at `https://dserver.bundestag.de/btp/{term2}/{term2}{session3}.pdf`, validated against Datenhandbuch stats BT1=136, BT2=168, BT3=46, BT4=38, BT5=24, BT6=38, BT7=53, BT8=58, BT9=26, BT10=128, BT11=162.
