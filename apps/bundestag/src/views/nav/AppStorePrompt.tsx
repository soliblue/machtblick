...
export function AppStorePrompt({ visible, title, description, actionLabel, dismissLabel, closeLabel, onDismiss }: Props) {
      ...
      <DialogPrimitive.Portal>
        ...
        >
          ...
          <div className="mt-l flex flex-col gap-s">
            <a
              href="https://apps.apple.com/us/app/machtblick/id6787755187"
