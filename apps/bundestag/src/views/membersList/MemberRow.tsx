...
export function MemberRow({ member }: Props) {
  return (
    <div
      className="relative grid grid-cols-[1fr_auto_auto_auto] items-center gap-m border-t py-m text-m transition-opacity hover:opacity-80 first:border-t-0 sm:grid-cols-[1fr_auto_auto_auto_auto]"
    ...
    >
      ...
      <span className="w-16 text-right sm:w-20">{pct(member.loyalty)}</span>
    </div>
  )
}
