    ...
    return (
      <main className="mx-auto max-w-3xl p-l">
        ...
        <p className="mb-l max-w-[65ch] text-m">
          ...
          <a href="/en/impressum/#kontakt" className="hover:underline">contact addresses listed in the imprint</a>{' '}
  ...
  return (
    <main className="mx-auto max-w-3xl p-l">
      ...
      <p className="mb-l max-w-[65ch] text-m">
        ...
        <a href="/impressum/#kontakt" className="hover:underline">im Impressum genannten Kontaktadressen</a>{' '}
